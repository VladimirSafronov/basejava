<%@ page import="basejava.model.SectionLine" %>
<%@ page import="basejava.model.SectionList" %>
<%@ page import="basejava.model.SectionOrganization" %>
                        ...
                        <c:forEach var="org"
                            ...
                            <c:forEach var="position" items="${org.positions}">
                                <jsp:useBean id="position"
                                             type="basejava.model.Organization.Position"/>
                                <tr>
